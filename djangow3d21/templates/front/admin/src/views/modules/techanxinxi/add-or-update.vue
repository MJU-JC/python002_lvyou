    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="特产详情" prop="techanxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.techanxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.techanxiangqing" label="特产详情" prop="techanxiangqing">
                    <span v-html="ruleForm.techanxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	clicknum : false,
      ...
      rules: {
          techanmingcheng: [
                { required: true, message: '特产名称不能为空', trigger: 'blur' },
          ],
          techanleixing: [
                { required: true, message: '特产类型不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          jifen: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.baozhiqi = true;
          ...
          if(o=='techanxiangqing'){
            this.ruleForm.techanxiangqing = obj[o];
	    this.ro.techanxiangqing = true;
            continue;
          }
          if(o=='thumbsupnum'){
	...
	this.ruleForm.techanxiangqing = this.ruleForm.techanxiangqing.replace(reg,'../../../djangow3d21/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
