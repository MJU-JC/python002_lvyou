<template>
  <div class="main-content">
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yonghu','增加积分') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="zengjiajifenCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'增加积分':'' }}</el-button>
                <el-button v-if="isAuth('yonghu','增加积分') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="zengjiajifenCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'增加积分':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yonghu','增加积分') && contents.tableBtnIcon == 0" type="success" size="mini" @click="zengjiajifenCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'增加积分':'' }}</el-button>
                <el-button v-if="isAuth('yonghu','扣减积分') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="koujianjifenCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'扣减积分':'' }}</el-button>
                <el-button v-if="isAuth('yonghu','扣减积分') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="koujianjifenCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'扣减积分':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yonghu','扣减积分') && contents.tableBtnIcon == 0" type="success" size="mini" @click="koujianjifenCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'扣减积分':'' }}</el-button>
    ...
    <zengjiajifen-cross-add-or-update v-if="zengjiajifenCrossAddOrUpdateFlag" :parent="this" ref="zengjiajifenCrossaddOrUpdate"></zengjiajifen-cross-add-or-update>
    <koujianjifen-cross-add-or-update v-if="koujianjifenCrossAddOrUpdateFlag" :parent="this" ref="koujianjifenCrossaddOrUpdate"></koujianjifen-cross-add-or-update>
...
import zengjiajifenCrossAddOrUpdate from "../zengjiajifen/add-or-update";
import koujianjifenCrossAddOrUpdate from "../koujianjifen/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      zengjiajifenCrossAddOrUpdateFlag: false,
      koujianjifenCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    zengjiajifenCrossAddOrUpdate,
    koujianjifenCrossAddOrUpdate,
  },
  methods: {
    contentStyleChange() {
    ...
    zengjiajifenCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.zengjiajifenCrossAddOrUpdateFlag = true;
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.zengjiajifenCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.zengjiajifenCrossaddOrUpdate.init(row.id,type);
      });
    },
    koujianjifenCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.koujianjifenCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yonghu');
      this.$storage.set('statusColumnName',statusColumnName);
      this.$storage.set('statusColumnValue',statusColumnValue);
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.koujianjifenCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.koujianjifenCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
    },
