<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出行天数" prop="chuxingtianshu">
          <el-input v-model="ruleForm.chuxingtianshu" 
              placeholder="出行天数" clearable  :readonly="ro.chuxingtianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出行天数" prop="chuxingtianshu">
              <el-input v-model="ruleForm.chuxingtianshu" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="出行路线" prop="chuxingluxian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="出行路线"
                  v-model="ruleForm.chuxingluxian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chuxingluxian" label="出行路线" prop="chuxingluxian">
                    <span>{{ruleForm.chuxingluxian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="游记内容" prop="youjineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.youjineirong" label="游记内容" prop="youjineirong">
                    <span v-html="ruleForm.youjineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fabushijian = true;
          ...
          if(o=='chuxingluxian'){
            this.ruleForm.chuxingluxian = obj[o];
	    this.ro.chuxingluxian = true;
            continue;
          }
          if(o=='youjineirong'){
	...
	this.ruleForm.youjineirong = this.ruleForm.youjineirong.replace(reg,'../../../djangow3d21/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
