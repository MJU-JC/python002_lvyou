<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="地区名称" prop="diqumingcheng">
          <el-input v-model="ruleForm.diqumingcheng" 
              placeholder="地区名称" clearable  :readonly="ro.diqumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="地区名称" prop="diqumingcheng">
              <el-input v-model="ruleForm.diqumingcheng" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='diqumingcheng'){
            this.ruleForm.diqumingcheng = obj[o];
	    this.ro.diqumingcheng = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `diqumingcheng/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.diqumingchengCrossAddOrUpdateFlag = false;
						 this.parent.search();
